...
const ServiceProviderDashboard = () => {
  ...
  const packages = [
    { id: 1, name: 'Premium Wedding Package', price: 'Rs. 200,000', bookings: 12, status: 'active' },
    { id: 2, name: 'Basic Photography', price: 'Rs. 50,000', bookings: 8, status: 'active' },
    { id: 3, name: 'Venue + Catering Combo', price: 'Rs. 400,000', bookings: 3, status: 'inactive' }
  ];

  const quickActions = [
    { label: 'Add New Package', icon: <Plus className="w-5 h-5 text-blue-600" />, color: 'bg-blue-50', hover: 'hover:bg-blue-100' },
    { label: 'View Bookings', icon: <Calendar className="w-5 h-5 text-purple-600" />, color: 'bg-purple-50', hover: 'hover:bg-purple-100' },
    { label: 'Contact Support', icon: <MessageSquare className="w-5 h-5 text-green-600" />, color: 'bg-green-50', hover: 'hover:bg-green-100' }
  ];
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
            {quickActions.map((action, index) => (
              <button
                key={index}
                className={`w-full flex items-center justify-between p-3 rounded-lg ${action.hover}`}
              >
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-slate-800">Featured Services</h2>
