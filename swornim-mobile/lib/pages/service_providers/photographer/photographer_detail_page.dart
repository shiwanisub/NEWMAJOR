...
class _PhotographerDetailPageState extends ConsumerState<PhotographerDetailPage> with TickerProviderStateMixin {
        ...
        background: Stack(
          ...
          children: [
            ...
            PageView.builder(
              ...
              itemCount: photographer.portfolio.isEmpty ? 1 : photographer.portfolio.length,
              onPageChanged: (index) {
                setState(() {
                ...
                return Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(photographer.portfolio[index]),
                      fit: BoxFit.cover,
                    ),
                  ),
                );
            ...
            if (photographer.portfolio.isNotEmpty)
              Positioned(
                ...
                child: Row(
                  ...
                  children: List.generate(photographer.portfolio.length, (index) {
  ...
  Widget _buildReviewsContent(ThemeData theme, Photographer photographer) {
    final reviews = photographer.reviews;
    return SliverToBoxAdapter(
      child: Container(
